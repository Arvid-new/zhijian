...
public class EnterLookCaiLiaoAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {

    private Activity context;

    public EnterLookCaiLiaoAdapter(@Nullable List<MultiItemEntity> data, Activity context) {
        super(data);
    ...
    protected void convert(final BaseViewHolder holder, final MultiItemEntity item) {
        switch (holder.getItemViewType()) {
            ...
            case TYPE_SPECIfICATION: // 规格
                ...
                holder.setText(R.id.number, lv3.number + "" + lv3.unit);
                break;
            default:
                break;
        }
