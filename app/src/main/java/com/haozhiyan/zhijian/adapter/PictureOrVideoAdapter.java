...
public class PictureOrVideoAdapter extends BaseQuickAdapter<LocalMedia, BaseViewHolder> {

    private int[] ints = {R.mipmap.photograph_icon, R.mipmap.shoot_video};

    private Context context;
    private List<LocalMedia> mediaList;

    public PictureOrVideoAdapter(Context context) {
