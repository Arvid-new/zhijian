package com.haozhiyan.zhijian.activity.reportforms.widget;
...
import static com.haozhiyan.zhijian.utils.DensityUtil.dip2px;
...
public class ProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float width0 = getDivide(bean.getYitongguo(), bean.getTotal()) * totalWidth;   //第一条线的宽度
        float width1 = getDivide(bean.getDaifuyan(), bean.getTotal()) * totalWidth;   //第二条线的宽度
        float width2 = getDivide(bean.getDaizhenggai(), bean.getTotal()) * totalWidth;   //第三条线的宽度
        float width3 = getDivide(bean.getGuanbi(), bean.getTotal()) * totalWidth;  //第四条线的宽度
        ...
        canvas.drawText(bean.getYizheggai(), width0 + width1, height / 2 - mHeight * 2, paint);
    }
