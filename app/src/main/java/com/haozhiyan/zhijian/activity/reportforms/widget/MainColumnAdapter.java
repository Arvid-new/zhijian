...
public class MainColumnAdapter extends RecyclerView.Adapter<MainColumnAdapter.UnLockViewHolder> {
    ...
    private void createRowView(LinearLayout linearLayout, List<String> datas) {
        ...
        for (int i = 0; i < datas.size(); i++) {
            ...
            setListener(textView,datas.get(i));//设置点击事件
         ...
         view.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 Toast.makeText(mContext,str,Toast.LENGTH_SHORT).show();
                  Intent intent = new Intent(mContext,GXYJActivity.class);
                  Bundle bundle = new Bundle();
                  bundle.putString("sectionId","30");
                  bundle.putString("sectionName","测试标段0613");
                  bundle.putString("towerId","1");
                  bundle.putString("towerName","1栋");
                  bundle.putString("unitId","2");
                  bundle.putString("unitName","2单元");
                  bundle.putString("partsDivision","分户");
                  bundle.putString("inspectionName","抹灰工程");
                  bundle.putString("inspectionSunName","灰饼验收");
