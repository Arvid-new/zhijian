...
/** 
 * DAO for table "WORK_PROJECT_BEAN".
*/
public class WorkProjectBeanDao extends AbstractDao<WorkProjectBean, String> {

    public static final String TABLENAME = "WORK_PROJECT_BEAN";

    /**
     * Properties of entity WorkProjectBean.<br/>
    ...
    */
    ...
    public WorkProjectBeanDao(DaoConfig config) {
        super(config);
    }
    
    public WorkProjectBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WORK_PROJECT_BEAN\" (" + //
                "\"PK_ID\" TEXT PRIMARY KEY NOT NULL ," + // 0: pkId
                "\"ITEAM_NAME\" TEXT," + // 1: iteamName
                "\"ITEM_ID\" TEXT);"); // 2: itemId
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_WORK_PROJECT_BEAN_PK_ID ON WORK_PROJECT_BEAN" +
                " (\"PK_ID\" ASC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WORK_PROJECT_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, WorkProjectBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, WorkProjectBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(WorkProjectBean entity) {
    ...
    @Override
    public WorkProjectBean readEntity(Cursor cursor, int offset) {
        WorkProjectBean entity = new WorkProjectBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, WorkProjectBean entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(WorkProjectBean entity, long rowId) {
        return entity.getPkId();
    }
    
    @Override
    public String getKey(WorkProjectBean entity) {
        if(entity != null) {
            return entity.getPkId();
        } else {
            return null;
