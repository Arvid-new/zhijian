 ...
 * 最赞列表
 */
public class Gcld_zan_Fragment extends BaseFragment {
    ...
    public int getLayoutResId() {
        return R.layout.gcld_zan_lis_layout;
    }
     ...
     * 获取最 赞 列表
     */
    private void listLightspotZz() {
        HttpRequest.get(getActivity()).url(ServerInterface.listLightspotZz)
                .params("pageSize", "10")
                .params("pageNo", page)
